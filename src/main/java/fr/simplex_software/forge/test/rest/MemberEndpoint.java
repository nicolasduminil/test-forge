...
import fr.simplex_software.forge.test.model.Member;
...
public class MemberEndpoint {
	...
	public Response findById(@PathParam("id") Long id) {
		TypedQuery<Member> findByIdQuery = em
				.createQuery(
						"SELECT DISTINCT m FROM Member m LEFT JOIN FETCH m.projects WHERE m.id = :entityId ORDER BY m.id",
						Member.class);
	...
	public List<Member> listAll(@QueryParam("start") Integer startPosition,
		...
		TypedQuery<Member> findAllQuery = em
				.createQuery(
						"SELECT DISTINCT m FROM Member m LEFT JOIN FETCH m.projects ORDER BY m.id",
						Member.class);
